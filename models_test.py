...
class TestCalendar(unittest.TestCase):
    ...
    def test_add_meeting(self):
        ...
        c.add_room(a)
        m = Meeting(
            datetime(2018, 8, 18, 9), datetime(2018, 8, 18, 10), 2, "project")
        self.assertTrue(c.add_meeting(m, r))
        n = Meeting(
            datetime(2018, 8, 18, 9, 30), datetime(2018, 8, 18, 10, 30), 2,
            "project2")
        self.assertFalse(c.add_meeting(n, r))
        l = Meeting(
            datetime(2018, 8, 18, 8, 30), datetime(2018, 8, 18, 9, 20), 2,
            "project3")
        ...
        self.assertFalse(c.add_meeting(l, r))
        j = Meeting(
            datetime(2018, 8, 18, 14, 30), datetime(2018, 8, 18, 15, 30), 2,
            "project5")
